...
const InventoryWarning = () => {
  ...
  let columns = [
    ...
    { title: '预警值', dataIndex: 'store_threshold', align: 'center', width: 100 },
    { title: '可用库存', dataIndex: 'stores', align: 'center', width: 100 },
  ];
  ...
  let params = {
    ...
    searchApi: { url: '/api/product/listStoreWarning' },
  }
  return (
    <div>
