...
const AccountForSales = () => {
  ...
  let columns = [
    { title: '销售日期', dataIndex: 'ctime', align: 'center', width: 110 },
    { title: '销售单据号', dataIndex: 'ordersn', align: 'center', width: 120 },
    { title: '业务类别', dataIndex: 'stype', align: 'center', width: 80 },
    ...(
      userType != 'xiaoshou' &&
      [{ title: '销售人员', dataIndex: 'sales_name', align: 'center', width: 150 }] || []
    ),
    // { title: '客户类别', dataIndex: 'a', align: 'center', width: 120 },
    { title: '客户', dataIndex: 'member_name', align: 'center', width: 100 },
    { title: '商品类别', dataIndex: 'category_name', align: 'center', width: 120 },
    { title: '商品编号', dataIndex: 'sku_id', align: 'center', width: 80 },
    ...
    { title: '数量', dataIndex: 'number', align: 'center', width: 90 },
    {
      title: '单价',
      dataIndex: 'price',
      align: 'center',
  ...
  let params = {
    searchItems,
    searchProps: {style: {overflowX: 'auto'}, btnStyle: {marginTop: '28px'}},
    columns,
    headerShow: false,
    addBtnShow: false,
    editBtnShow: false,
