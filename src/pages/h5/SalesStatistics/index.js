  ...
  let columns = [
    ...(
      ...
      [
        ...
        { title: '商品编号', dataIndex: 'sku_id', align: 'center', width: 100, sorter: true },
        { title: '商品名称', dataIndex: 'prod_name', align: 'center', width: 140, sorter: true },
        { title: '规格型号', dataIndex: 'pname', align: 'center', width: 100 },
        { title: '基本单位', dataIndex: 'unit_name', align: 'center', width: 90 }
      ] || []
    ),
    ...(
      basicParams.type == 2 &&
    ...
    { title: '销售基本数量', dataIndex: 'number', align: 'center', width: 120, sorter: true },
    {
      title: '单价',
      dataIndex: 'price',
      align: 'center',
