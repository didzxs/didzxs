...
const AccountsReceivable = (props) => {
  ...
  let columns = [
    ...
    { title: '单据日期', dataIndex: 'operated_at', align: 'center', width: 110 },
    { title: '单据编号', dataIndex: 'sn_self', align: 'center', width: 120 },
    { title: '业务类型', dataIndex: 's_name', align: 'center', width: 80 },
    {
      title: '增加应收款',
      dataIndex: 'to_get',
      align: 'center',
  ...
  return (
    <div>
      <MobileHeader />
      <Filtrate items={searchItems} onSearch={onSearchClick} wrappedComponentRef={ref => f1 = ref} btnStyle={{marginTop: '15px'}} />
      <Container
        headerShow={false}
        heightAuto={true}
        exportBtn={onExport}
